...
export const CATEGORY_META: Record<FactCategory, { label: string; labelNl: string; korean: string; color: string; border: string; bg: string }> = {
  history:       { label: 'History',       labelNl: 'Geschiedenis', korean: '역사', color: '#fcd34d', border: 'rgba(245,158,11,0.35)', bg: 'rgba(180,83,9,0.12)' },
  culture:       { label: 'Culture',       labelNl: 'Cultuur',       korean: '문화', color: '#a78bfa', border: 'rgba(139,92,246,0.35)', bg: 'rgba(109,40,217,0.12)' },
  food:          { label: 'Food',          labelNl: 'Eten',          korean: '음식', color: '#f97316', border: 'rgba(249,115,22,0.35)', bg: 'rgba(194,65,12,0.12)' },
  technology:    { label: 'Technology',    labelNl: 'Technologie',   korean: '기술', color: '#38bdf8', border: 'rgba(14,165,233,0.35)', bg: 'rgba(2,132,199,0.12)' },
  entertainment: { label: 'Entertainment', labelNl: 'Entertainment', korean: '한류', color: '#f472b6', border: 'rgba(236,72,153,0.35)', bg: 'rgba(190,24,93,0.12)' },
  geography:     { label: 'Geography',     labelNl: 'Geografie',     korean: '지리', color: '#6ee7b7', border: 'rgba(16,185,129,0.35)', bg: 'rgba(5,150,105,0.12)' },
  society:       { label: 'Society',       labelNl: 'Samenleving',   korean: '사회', color: '#c4b5fd', border: 'rgba(167,139,250,0.35)', bg: 'rgba(109,40,217,0.10)' },
}

const KOREA_FACT_TEXT_NL: Record<string, string> = {
  h001: 'Volgens de legende werd Korea in 2333 v.Chr. gesticht door Dangun, de zoon van Hwanung en een berenvrouw die mens werd na honderd dagen knoflook en bijvoet.',
  h002: 'Gojoseon geldt als Korea\'s eerste koninkrijk en als een van de vroegste staten in Oost-Azie. Daardoor heeft het schiereiland een uitzonderlijk lange aaneengesloten geschiedenis.',
  h003: 'Meer dan zeven eeuwen was het Koreaanse schiereiland verdeeld tussen Goguryeo, Baekje en Silla. Elk rijk had eigen kunst, bondgenoten en politieke ambities.',
  h004: 'Goguryeo was het noordelijkste van de Drie Koninkrijken en groeide uit tot een machtig Oost-Aziatisch rijk dat tot diep in Mantsjoerije reikte.',
  h005: 'Silla verenigde het schiereiland in 668 met hulp van Tang-China, maar vocht daarna opnieuw om Chinese troepen te verdrijven en Koreaanse soevereiniteit te behouden.',
  h006: 'De Cheomseongdae-sterrenwacht uit 632 staat nog altijd in Gyeongju en geldt als de oudste bewaard gebleven astronomische sterrenwacht van Azie.',
  h007: 'De naam Korea komt van Goryeo, de dynastie die van 918 tot 1392 regeerde en via Arabische en Perzische handelaren bekend werd in de middeleeuwse wereld.',
  h008: 'Korea gebruikte rond 1230 al losse metalen drukletters, ongeveer twee eeuwen voor Gutenbergs pers. De Jikji uit 1377 is het oudste bewaarde boek gedrukt met metalen letters.',
  h009: 'De Tripitaka Koreana bestaat uit meer dan 80.000 houten drukblokken met de boeddhistische canon. Ze wordt bewaard in Haeinsa en staat op de UNESCO-werelderfgoedlijst.',
  h010: 'Goryeo-celadon met zijn jadegroene glazuur werd zo hoog gewaardeerd dat Chinese ambachtslieden het als het beste celadon ter wereld erkenden.',
  h011: 'De Joseon-dynastie regeerde meer dan vijf eeuwen en bepaalde diepgaand de Koreaanse taal, confuciaanse ethiek, architectuur en kunst.',
  h012: 'Koning Sejong gaf in 1443 opdracht tot Hangul. Het schrift moest zo helder zijn dat ook gewone mensen konden leren lezen.',
  h013: 'Gyeongbokgung werd in 1395 gebouwd als hoofd paleis van Joseon. Het complex werd in 1592 verwoest en wordt sinds 1990 stap voor stap hersteld.',
  h014: 'Admiraal Yi Sun-sin won tijdens de Japanse invasies van 1592-1598 tientallen zeeslagen zonder nederlaag en geldt als een van Korea\'s grootste helden.',
  h015: 'Het schildpadschip van Yi Sun-sin was een vroege gepantserde oorlogsbodem. Het gespijkerde dak maakte enteren bijna onmogelijk.',
  h016: 'Hwaseong, voltooid in 1796, combineerde oosterse en westerse bouwtechniek en gebruikte mobiele kranen. Het fort staat op de UNESCO-werelderfgoedlijst.',
  h017: 'Korea werd in de negentiende eeuw het Kluizenaarskoninkrijk genoemd door zijn strenge isolatiebeleid en beperkte buitenlandse contacten.',
  h018: 'Japan annexeerde Korea in 1910 en onderdrukte 35 jaar lang taal, namen en culturele identiteit. Koreanen werden zelfs gedwongen Japanse namen aan te nemen.',
  h019: 'Op 1 maart 1919 demonstreerden meer dan twee miljoen Koreanen vreedzaam tegen Japanse koloniale overheersing. De dag is nog altijd een nationale herdenkingsdag.',
  h020: 'De Koreaanse Oorlog begon op 25 juni 1950 toen Noord-Koreaanse troepen de 38e breedtegraad overstaken. Er kwam in 1953 een wapenstilstand, geen vredesverdrag.',
  h021: 'Zuid-Korea groeide na de Koreaanse Oorlog van extreme armoede uit tot een van de grootste economieen ter wereld. Die groei heet het Wonder aan de Han-rivier.',
  h022: 'De Olympische Spelen van Seoel in 1988 toonden Zuid-Korea als moderne democratie en economische macht, slechts 35 jaar na de verwoesting van de oorlog.',
  h023: 'Korea heeft uitzonderlijk veel prehistorische dolmens. Ongeveer 40.000 van de 60.000 bekende dolmens ter wereld liggen op het Koreaanse schiereiland.',
  h024: 'De Hwarang waren jonge elitekrijgers uit Silla die krijgskunst, muziek, kunst en confuciaanse ethiek bestudeerden. Hun erecode beinvloedde de Koreaanse cultuur.',
  h025: 'Tijdens de Mongoolse invasies trok het Goryeo-hof zich terug op Ganghwa en hield bijna dertig jaar stand tegen het Mongoolse Rijk.',
  h026: 'Sejong ontwierp Hangul mede omdat Koreaanse klanken niet nauwkeurig met Chinese karakters konden worden weergegeven.',
  g001: 'Zuid-Korea is ongeveer zo groot als Portugal, maar telt bijna 52 miljoen inwoners. Het is daardoor een van de dichtstbevolkte landen ter wereld.',
  g002: 'Ongeveer zeventig procent van Zuid-Korea is bergachtig. Dat beperkte vlakke landbouwgrond en stimuleerde terrasbouw en andere slimme landbouwvormen.',
  g003: 'Jeju is een vulkanisch eiland met Hallasan, de hoogste berg van Zuid-Korea. Het eiland staat op de UNESCO-lijst voor natuurlijk werelderfgoed.',
  g004: 'De Han-rivier loopt dwars door Seoel en vormt een centrale levensader met parken, fietspaden en ontmoetingsplekken langs de oevers.',
  g005: 'Zuid-Korea heeft meer dan drieduizend eilanden langs de west- en zuidkust. Veel zijn onbewoond en vormen spectaculaire kustlandschappen.',
  g006: 'De DMZ tussen Noord- en Zuid-Korea is zwaar bewaakt, maar werd door het gebrek aan menselijke activiteit ook een belangrijk natuurgebied.',
  g007: 'In de metropoolregio Seoel woont ongeveer de helft van de Zuid-Koreaanse bevolking, een van de sterkste stedelijke concentraties ter wereld.',
  g008: 'Zuid-Korea heeft vier duidelijke seizoenen: kersenbloesem in de lente, hete moessonzomers, heldere herfstkleuren en koude winters.',
  g009: 'Dokdo heeft grote symbolische waarde voor Koreanen. Zuid-Korea bestuurt de rotsachtige eilanden, maar Japan maakt er ook aanspraak op.',
  c001: 'Korea gebruikte lang een eigen leeftijdssysteem waarbij iemand bij geboorte al een jaar was. Sinds 2023 geldt officieel de internationale leeftijd.',
  c002: 'Chuseok is een belangrijk oogstfeest rond volle maan. Families eten samen, eren voorouders en bezoeken graven, wat tot grote reisdrukte leidt.',
  c003: 'Seollal is Koreaans Nieuwjaar volgens de maankalender. Jongeren maken een diepe buiging voor ouderen en krijgen zegeningen en geldgeschenken.',
  c004: 'Hanbok is traditionele Koreaanse kleding met heldere kleuren en eenvoudige lijnen. Het wordt nog gedragen bij bruiloften, feestdagen en mode-evenementen.',
  c005: 'Nunchi is de kunst om een sociale situatie snel aan te voelen. Goede nunchi betekent dat je onuitgesproken signalen en hierarchie begrijpt.',
  c006: 'Koreaans eten is sterk gericht op delen. Gerechten staan midden op tafel en bijgerechten zoals kimchi worden vaak gratis bijgevuld.',
  c007: 'Jjimjilbang zijn publieke badhuizen en sauna\'s die dag en nacht open zijn. Mensen ontspannen, slapen en spreken er af met vrienden of familie.',
  c008: 'Noraebang zijn privekaraokekamers. Je huurt een kamer voor je groep en zingt zonder onbekend publiek, waardoor karaoke laagdrempelig blijft.',
  c009: 'Koreaans kent meerdere beleefdheidsniveaus. De juiste vorm hangt af van leeftijd, status en relatie tussen spreker en luisteraar.',
  c010: 'Han is een Koreaans begrip voor diep verdriet, wrok en veerkracht uit historische tegenslag. Het komt vaak terug in kunst en verhalen.',
  c011: 'Taekwondo is Korea\'s nationale sport en sinds 2000 olympisch. Miljoenen mensen in meer dan tweehonderd landen beoefenen de krijgskunst.',
  c012: 'Ppali ppali betekent haast, haast en beschrijft Korea\'s snelle werk- en servicecultuur. Het hielp de snelle economische ontwikkeling, maar verhoogt ook stress.',
  c013: 'Confuciaanse waarden zoals respect voor ouderen, onderwijs, harmonie en loyaliteit vormen al eeuwen de Koreaanse samenleving.',
  c014: 'Sjamanisme is een van Korea\'s oudste spirituele tradities. Mudang voeren rituelen uit om met geesten te communiceren en geluk of genezing te vragen.',
  c015: 'Zuid-Korea heeft veel cosmetische chirurgie per hoofd van de bevolking. Ingrepen zoals dubbele ooglidcorrecties zijn sociaal bespreekbaar.',
  c016: 'Pansori is traditioneel muzikaal verteltheater met een zanger en drummer. Een uitvoering kan uren duren en staat op de UNESCO-lijst voor immaterieel erfgoed.',
  c017: 'Het getal vier geldt als ongelukkig omdat sa klinkt als het woord voor dood. Sommige gebouwen slaan daarom de vierde verdieping over.',
  c018: 'Skinship verwijst naar gewone fysieke genegenheid tussen goede vrienden, zoals hand vasthouden of tegen elkaar leunen, zonder romantische betekenis.',
  c019: 'Boeddhisme kwam in 372 naar Korea en beinvloedde kunst, filosofie en tempelbouw. Zuid-Korea telt honderden geregistreerde boeddhistische tempels.',
  c020: 'De haenyeo van Jeju zijn vrouwelijke vrijduikers die zonder perslucht zeevruchten oogsten. Hun eeuwenoude traditie is UNESCO-immaterieel erfgoed.',
  c021: 'Ssireum is Koreaans volksworstelen. Tegenstanders grijpen elkaars gordel en proberen de ander op de grond te werpen.',
  f001: 'Kimchi is meer dan een gerecht: het is een cultureel basisvoedsel. Gefermenteerde groenten met chili, knoflook en gember staan bij bijna elke maaltijd op tafel.',
  f002: 'Zuid-Korea eet per hoofd van de bevolking meer instant ramyeon dan enig ander land. Shin Ramyun is wereldwijd een van de bekendste merken.',
  f003: 'Kimjang is het gezamenlijk maken van grote hoeveelheden kimchi voor de winter. De traditie staat sinds 2013 op de UNESCO-lijst.',
  f004: 'Korean BBQ laat gasten vlees aan tafel grillen. Het is een van de bekendste Koreaanse eetervaringen buiten Korea.',
  f005: 'Soju is de meest verkochte sterke drank ter wereld naar volume. Vooral Jinro Chamisul verkoopt jaarlijks enorme aantallen flessen.',
  f006: 'Tteok, Koreaanse rijstcake, hoort bij feesten en rituelen. Tteokguk eten met Nieuwjaar symboliseert een jaar ouder worden.',
  f007: 'Koreaanse streetfood is beroemd om tteokbokki, hotteok, sundae en bungeoppang, die in vrijwel elke stad te vinden zijn.',
  f008: 'Mukbang, livestreamen terwijl je eet en met kijkers praat, ontstond rond 2010 in Zuid-Korea en werd daarna wereldwijd bekend.',
  f009: 'Doenjang is gefermenteerde sojabonenpasta en een basis van de Koreaanse keuken. Traditioneel rijpt het in aardewerken onggi-potten.',
  f010: 'Koreaanse convenience stores verkopen complete maaltijden, ramyeon die je ter plekke kookt, kimbap en warme snacks.',
  f011: 'Makgeolli is een melkachtige, licht bruisende rijstwijn en een van Korea\'s oudste alcoholische dranken.',
  f012: 'Bibimbap betekent gemengde rijst: rijst met groenten, gochujang en vaak ei of rundvlees, alles door elkaar gemengd voor het eten.',
  f013: 'Korea heeft een uitzonderlijk snelle bezorgcultuur. Veel eten kan dag en nacht binnen korte tijd worden bezorgd.',
  f014: 'Samgyeopsal, dikke plakken buikspek aan tafel gegrild, is zo populair dat 3 maart informeel Samgyeopsal-dag wordt genoemd.',
  t001: 'Zuid-Korea staat vaak bovenaan in internetsnelheid en breedbanddekking en legde vroeg landelijke glasvezelnetwerken aan.',
  t002: 'Samsung Electronics is een van de waardevolste bedrijven ter wereld en maakt een groot deel van de Zuid-Koreaanse export uit.',
  t003: 'Samsung en SK Hynix beheersen samen een groot deel van de wereldmarkt voor DRAM-geheugenchips.',
  t004: 'KakaoTalk wordt door bijna alle Zuid-Koreanen gebruikt en is sociaal bijna net zo belangrijk als een telefoonnummer.',
  t005: 'LG Electronics liep voorop met OLED-tv-technologie, die nu in veel toptoestellen en schermen wordt gebruikt.',
  t006: 'Zuid-Korea lanceerde in april 2019 als eerste land een landelijk 5G-netwerk.',
  t007: 'PC-bangs zijn 24-uurs gamingcafes met krachtige computers, eten en headsets. Ze maakten games als StarCraft en League of Legends groot.',
  t008: 'Hyundai groeide van een bekritiseerd automerk uit tot een van de grootste en best beoordeelde autofabrikanten ter wereld.',
  t009: 'Incheon International Airport wordt vaak tot de beste luchthavens ter wereld gerekend en heeft onder meer spa\'s, winkels en transitfaciliteiten.',
  t010: 'De KTX-hogesnelheidstrein verbindt Seoel en Busan in minder dan 2,5 uur en veranderde de economische kaart van Korea.',
  t011: 'POSCO begon in 1968 met beperkte middelen en groeide uit tot een van de grootste staalproducenten ter wereld.',
  t012: 'Meer dan 95 procent van de Zuid-Koreanen bezit een smartphone, een van de hoogste percentages ter wereld.',
  t013: 'De metro van Seoel is een van de grootste en drukste metrosystemen ter wereld en staat bekend om netheid, wifi en punctualiteit.',
  e001: 'Hallyu, de Koreaanse Golf, verwijst naar de wereldwijde verspreiding van Koreaanse cultuur: drama, K-pop, film, eten, beauty, mode en taal.',
  e002: 'BTS was de eerste Koreaanse act met een nummer een hit in de Amerikaanse Billboard Hot 100 en trad ook op bij de Grammy Awards.',
  e003: 'Parasite van Bong Joon-ho won in 2020 als eerste niet-Engelstalige film de Oscar voor beste film.',
  e004: 'Squid Game werd in 2021 Netflix\' meest bekeken serie en liet zien dat Koreaanse verhalen wereldwijd mainstream waren geworden.',
  e005: 'Gangnam Style van PSY bereikte in 2012 als eerste YouTube-video een miljard views en maakte moderne Koreaanse popcultuur wereldwijd zichtbaar.',
  e006: 'K-pop is een strak georganiseerd systeem waarin trainees vaak jaren trainen in zang, dans, acteren en talen voor hun debuut.',
  e007: 'StarCraft werd eind jaren negentig een nationaal fenomeen in Zuid-Korea, met professionele spelers, tv-kanalen en volle arena\'s.',
  e008: 'Koreaanse cinema bracht internationaal invloedrijke regisseurs voort zoals Bong Joon-ho, Park Chan-wook en Kim Ki-duk.',
  e009: 'K-beauty populariseerde BB-cream, sheet masks, essence en meerstaps huidverzorging. De industrie is wereldwijd miljarden waard.',
  e010: 'Webtoons, verticale digitale strips voor smartphones, ontstonden rond 2003 in Zuid-Korea en werden een wereldwijd medium.',
  e011: 'K-drama\'s worden naar meer dan honderd landen geëxporteerd en bouwden grote fanbases op in Azie, Latijns-Amerika en het Midden-Oosten.',
  e012: 'BLACKPINK was in 2019 de eerste K-popgroep die Coachella headlinede en bevestigde K-pops plek in westerse popmuziek.',
  s001: 'Zuid-Korea heeft een zeer intense onderwijscultuur, vaak education fever genoemd, met lange schooldagen en avondlessen op hagwons.',
  s002: 'De Suneung is het jaarlijkse toelatingsexamen voor universiteiten. Op examendag worden vluchten aangepast en helpt de politie late studenten.',
  s003: 'Gezonde Zuid-Koreaanse mannen moeten ongeveer 18 tot 21 maanden militaire dienst doen vanwege de voortdurende spanning met Noord-Korea.',
  s004: 'Zuid-Korea heeft een van de laagste geboortecijfers ter wereld, wat grote demografische en economische problemen veroorzaakt.',
  s005: 'De sampo-generatie verwijst naar jongeren die daten, trouwen en kinderen krijgen opgeven door hoge kosten, onzeker werk en competitie.',
  s006: 'Zuid-Korea veranderde binnen een generatie van militaire dictatuur in levendige democratie, mede door massale protesten in 1987.',
  s007: 'President Park Geun-hye werd in 2017 afgezet na maanden van vreedzame kaarslichtprotesten met miljoenen deelnemers.',
  s008: 'Koreaanse gezinnen geven uitzonderlijk veel uit aan priveonderwijs, bijles, muzieklessen en extra activiteiten voor kinderen.',
  s009: 'Koreaanse mannen besteden meer aan huidverzorging dan mannen in andere landen; verzorgingsroutines en lichte make-up zijn genormaliseerd.',
  s010: 'Jeong is een diepe emotionele band die langzaam ontstaat door gedeelde ervaringen en centraal staat in Koreaanse relaties.',
  s011: 'Zuid-Korea is religieus divers: christendom, boeddhisme en geen religieuze binding bestaan naast elkaar, vaak met gemengde praktijken.',
  s012: 'Seoel draait op 24-uursgemak: apotheken, restaurants, karaoke, sportscholen, spa\'s en studiecafes zijn vaak tot laat of altijd open.',
  s013: 'Zuid-Korea heeft veel grote wereldbedrijven per inwoner, waaronder Samsung, Hyundai, SK, LG en Lotte.',
  s014: 'Chaebol zijn familiegeleide conglomeraten die Korea\'s groei versnelden, maar ook kritiek krijgen wegens machtsconcentratie en corruptierisico.',
  s015: 'Hanguldag op 9 oktober viert de afkondiging van Sejongs schrift in 1446. Weinig landen hebben een feestdag voor hun schrift.',
  h027: 'De Jeulmun-cultuur leefde vanaf ongeveer 8000 v.Chr. op het Koreaanse schiereiland en liet kamversierd aardewerk achter.',
  h028: 'De Mumun-periode bracht landbouwdorpen, rijst en gierst naar Korea en liet enorme stenen dolmens na.',
  h029: 'IJzertechnologie bereikte Korea rond 300 v.Chr. en versnelde staatsvorming door betere werktuigen en wapens.',
  h030: 'Baekje werd een culturele brug tussen Korea, China en Japan en bracht schrift, boeddhisme en ambachtelijke kennis naar de Japanse eilanden.',
  h031: 'De Baekje-geleerde Wani wordt traditioneel gezien als degene die Chinese karakters en confuciaanse teksten naar Japan bracht.',
  h032: 'Baekje stuurde in 552 boeddhistische teksten en een Boeddhabeeld naar Japan, wat de Japanse religieuze geschiedenis veranderde.',
  h033: 'Balhae werd gesticht na de val van Goguryeo en beheerste Mantsjoerije en delen van het Russische Verre Oosten.',
  h034: 'In de Latere Drie Koninkrijken viel Silla uiteen, waarna Wang Geon het schiereiland in 936 herenigde en Goryeo stichtte.',
  h035: 'Goryeo voerde in 958 een ambtenarenexamen in, waardoor talentvolle geleerden buiten de erfelijke elite regeringsfuncties konden krijgen.',
  h036: 'De Mongoolse invasies van Goryeo duurden bijna dertig jaar; het hof hield 28 jaar stand op Ganghwa voor het vazalstatus accepteerde.',
  h037: 'De Imjin-oorlog verwoestte Joseon zeven jaar lang. Miljoenen mensen leden onder invasies, plundering en ontvoering van ambachtslieden.',
  h038: 'In Japan staat de Imjin-oorlog ook bekend als de pottenbakkersoorlog omdat Koreaanse keramisten werden weggevoerd en Japanse keramiek sterk beinvloedden.',
  h039: 'Joseon werd in 1627 en 1636 getroffen door Mantsjoe-invasies. De vernederende overgave van koning Injo bleef diep in het geheugen gegrift.',
  h040: 'Koning Yeongjo regeerde 52 jaar, hervormde belastingen en steunde praktische geleerdheid, maar zijn regering werd overschaduwd door kroonprins Sado.',
  h041: 'Koning Jeongjo stimuleerde hervorming, bouwde Hwaseong, steunde Silhak en richtte de koninklijke bibliotheek Gyujanggak op.',
  h042: 'Donghak mengde confucianisme, boeddhisme en sjamanisme met een oproep tot gelijkheid en verzet tegen buitenlandse invloed.',
  h043: 'De Eerste Chinees-Japanse Oorlog werd grotendeels op Koreaanse bodem uitgevochten en trok Korea verder in Japans invloedssfeer.',
  h044: 'Koningin Myeongseong werd in 1895 door Japanse agenten in haar paleis vermoord, een schokkende daad van staatsgeweld.',
  h045: 'Koning Gojong riep in 1897 het Koreaanse Keizerrijk uit om volledige onafhankelijkheid te claimen tegenover China en Japan.',
  h046: 'Het Eulsa-verdrag van 1905 maakte Korea onder Japanse druk tot protectoraat en ontketende breed verzet.',
  h047: 'Ahn Jung-geun doodde in 1909 Ito Hirobumi in Harbin en wordt in Korea vereerd als patriot en martelaar.',
  h048: 'De Koreaanse Voorlopige Regering werd in 1919 in Shanghai opgericht en werkte in ballingschap aan onafhankelijkheid tot 1945.',
  h049: 'Yun Bong-gil pleegde in 1932 een aanslag op een Japanse militaire ceremonie in Shanghai en werd een symbool van antikoloniaal verzet.',
  h050: 'Tijdens de Tweede Wereldoorlog werden honderdduizenden Koreaanse vrouwen gedwongen tot seksuele slavernij voor Japanse strijdkrachten.',
  h051: 'Na de Tweede Wereldoorlog verdeelden de Sovjet-Unie en de Verenigde Staten Korea haastig langs de 38e breedtegraad.',
  h052: 'Zuid-Korea werd op 15 augustus 1948 uitgeroepen; Noord-Korea volgde op 9 september, waarmee de deling werd vastgelegd.',
  h053: 'De Koreaanse Oorlog begon op 25 juni 1950 om vier uur \'s ochtends met een Noord-Koreaanse verrassingsaanval.',
  h054: 'MacArthurs landing bij Incheon op 15 september 1950 keerde het verloop van de Koreaanse Oorlog en maakte de herovering van Seoel mogelijk.',
  h055: 'De Slag bij het Chosin-reservoir werd bij extreme kou uitgevochten; VN-troepen braken omsingeling door Chinese strijdkrachten.',
  h056: 'Zuid-Korea stuurde meer dan 320.000 soldaten naar Vietnam; Amerikaanse betalingen hielpen de Koreaanse economische groei financieren.',
  h057: 'Park Chung-hee greep in 1961 de macht en industrialiseerde Korea autoritair, een erfenis die nog altijd fel wordt besproken.',
  h058: 'De Opstand van Gwangju in 1980 werd bloedig neergeslagen en groeide uit tot symbool van de democratische beweging.',
  h059: 'De Junidemocratiebeweging van 1987 dwong directe presidentsverkiezingen af en markeerde Korea\'s overgang naar democratie.',
  h060: 'De Aziatische financiele crisis van 1997 trof Korea zwaar; burgers doneerden goud om de nationale schuld te helpen aflossen.',
  h061: 'Kim Dae-jung won in 2000 de Nobelprijs voor de Vrede voor zijn Zonneschijnbeleid en de eerste inter-Koreaanse top.',
  h062: 'Park Geun-hye werd in 2017 afgezet na massale kaarslichtprotesten, een vreedzaam voorbeeld van burgerlijke democratische actie.',
  h063: 'De Hwarang van Silla combineerden krijgskunst, poëzie, muziek en ethiek en gelden als voorlopers van moderne taekwondowaarden.',
  h064: 'Silla versloeg met Tang-China Baekje en Goguryeo, maar verdreef later Tang zelf om Korea onder Koreaanse heerschappij te verenigen.',
  h065: 'Monnik Jang Bogo bouwde in de negende eeuw een maritiem handelsnetwerk over de Gele Zee tussen China, Korea en Japan.',
  h066: 'De Silhak-beweging legde nadruk op praktische kennis, empirisch onderzoek en sociale hervorming tegenover orthodox neo-confucianisme.',
  h067: 'Het General Sherman-incident van 1866 leidde tot Amerikaanse druk op Korea en later tot een mislukte poging om het land open te dwingen.',
  h068: 'Het Joseon-VS-verdrag van 1882 was Korea\'s eerste verdrag met een westerse macht en opende een nieuw tijdperk van buitenlandse betrokkenheid.',
}

export function getKoreaFactText(fact: KoreaFact, locale: 'en' | 'nl') {
  return locale === 'nl' ? (KOREA_FACT_TEXT_NL[fact.id] ?? fact.text) : fact.text
}
